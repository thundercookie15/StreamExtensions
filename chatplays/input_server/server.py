...
# local imports
from chatplays.streamchatwars import ColorText
from chatplays.streamchatwars._shared.types import InputServerDataPack
# internal imports
...
def main() -> None:
    ...
    gamepad_server: chatplays.streamchatwars.virtual_input.input_server.LocalInputServer
    gamepad_server = chatplays.streamchatwars.virtual_input.input_server.LocalInputServer()
