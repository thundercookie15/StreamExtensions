...
from chatplays.streamchatwars._shared.types import Partial_VerbParamDict, VerbParamDict
...
class PokemonEmerald_KB_Actionset(Keyboard_Actionset):
    name: ClassVar[str] = 'Pokemon Emerald (Keyboard)'

    '''
    Pokemon Emerald Controls (Keyboard):
...
class PokemonEmerald_GP_Actionset(Gamepad_Actionset):
    name: ClassVar[str] = 'Pokemon Emerald (Gamepad)'

    '''
    Pokemon Emerald Controls (XInput):
...
_EXPORT_CLASSES_: list[type[Actionset]] = [
    PokemonEmerald_KB_Actionset,
    PokemonEmerald_GP_Actionset
]
