...
from .client import Reactor as Reactor, ServerConnection as ServerConnection, \
    SimpleIRCClient as SimpleIRCClient
...
class AioConnection(ServerConnection):
    ...
    async def connect(self, server, port, nickname, password: Any | None = ..., username: Any | None = ...,
                      ircname: Any | None = ..., connect_factory=...): ...
